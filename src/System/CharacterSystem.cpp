...
namespace Argo {
    namespace CharacterSystem
    {
        ...
        void update(CharacterController& controller, Camera& camera, Rigidbody& rb)
        {
            ...
            rb.velocity += rb.acceleration * Game::deltaTime;
            camera.position += rb.velocity * Game::deltaTime;
            ...
            {
                rb.velocity *= rb.friction * Game::deltaTime;
            }
            ...
            // They already represent a change in position
